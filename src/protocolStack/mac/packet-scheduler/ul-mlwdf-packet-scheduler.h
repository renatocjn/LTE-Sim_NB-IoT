...
#ifndef MLWDF_UPLINK_PACKET_SCHEDULER_H_
#define MLWDF_UPLINK_PACKET_SCHEDULER_H_

#include "enhanced-uplink-packet-scheduler.h"
#include <map>

class MlwdfUplinkPacketScheduler : public EnhancedUplinkPacketScheduler {

public:
	MlwdfUplinkPacketScheduler ();
	virtual ~MlwdfUplinkPacketScheduler();
